...
/**
 * Clase que representará a Argentina con los métodos del controlador
 *
 ...
 */
public class ArgentinaControlador implements Sucursal {

    /* Para accedar a las vistas y controladores*/
    static ArgentinaVista vista = new ArgentinaVista();
    static ArgentinaControlador argentina = new ArgentinaControlador();
    ...
    /*Porsches de Argentina*/
    PorscheArgentina autosArgentina = new PorscheArgentina();
                ...
                while (true) {
                    switch (vista.mostrarMenuVista()) {
                        ...
                        case 2:
                            ...
                            return;
                        default:
                            System.out.println("\n\tOpción no disponible boludo.");
                    }
                }
            } catch (NumberFormatException e) {
                System.out.println("\n\tTypea una entrada valida boludo!");
            ...
            try {
                switch (vista.armarAutoModelo()) {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        System.out.println(" \t Escoge una opción valida boludo");
                }
    ...
    public void autosPrefabricados() {
        ...
        Porsche auto = argentina.eligeAuto();
        auto.muestraPorsche();
    }
    ...
    public String muestraAutos() {
        String aux = "";
        iterador = autosArgentina.getIterador();
    ...
    private Porsche auxiliar(String porsche) {
        ...
        while (iterador.hasNext()) {
            ...
            if (auxiliar.nombre.equals(porsche)) {
            	System.out.println("�Felicidades por tu nueva compra pibito! \n"+auxiliar.muestraPorsche());
                return auxiliar;
            }
        }
                ...
                while (true) {
                    switch (vista.eligeAutoVista()) {
                        ...
                        case 5:
                            ...
                            return this.auxiliar("5.- Porsche 911 Edicion Especial");
                        default:
                            System.out.println("\tEscoge una opcion valida boludo\n ");
                    }
                }
            } catch (NumberFormatException e) {
                System.out.println(" \t Ingresa un numero boludo");
            }
        }
    }
    ...
    public void terminarCompra() {
        ...
        try {
            ...
            Logger.getLogger(ArgentinaControlador.class.getName()).log(Level.SEVERE, null, ex);
        }
        vista.proxyVista();
    }
