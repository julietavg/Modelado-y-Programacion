...
/**
 * Clase que representará a Mexico con los métodos de vista
 *
...
public class MexicoVista {
    ...
    public int mostrarMenuVista() {
        System.out.println(" Bienvenido a la sucursusal mexicana"
    ...
    public int armarAutoModelo() {
    	System.out.println("Escoge los componentes de tu coche\n ");
    ...
    public int eligeAutoVista() {
        System.out.println("Elige el numero del carro que deseas comprar:");
        int opcion = Integer.parseInt(scan.nextLine());
        return opcion;
    }
    ...
    public void proxyVista() {
        System.out.println("Bienvenido a tu compra segura");
