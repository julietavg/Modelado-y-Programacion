...
/**
 * Clase que realiza el cobro de dos dispositivos de Memeflix la cual implementa
 ...
 *
 */
public class Memeflix2 implements Cobrador {
    ...
    public void cobrar(Usuario cliente, Sujeto empresa) {
        ...
        if (cliente.getSaldo() >= 170) {
            cliente.setSaldo(cliente.getSaldo() - 170);
            System.out.println("############################### \n"
                    + '\t' + "Bienvenid@ " + cliente.getNombre() + "\n"
                    + '\t' + "    MEMEFLIX" + "\n"
                    + "############################### \n"
                    + "  se realizo un cobro de $" + 170 + "\n"
                    + "      por 2 dispositivos \n"
