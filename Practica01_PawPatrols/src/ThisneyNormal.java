...
/**
 * Clase que realiza el cobro del costo normal de Thisney la cual implementa
 ...
 *
 */
public class ThisneyNormal implements Cobrador{
    ...
    public void cobrar(Usuario cliente, Sujeto empresa) {
        ...
        if (cliente.getSaldo() >= 160) {
            cliente.setSaldo(cliente.getSaldo() - 160);
            System.out.println("############################### \n"
                    + '\t' + "Bienvenid@ " + cliente.getNombre() + "\n"
                    + '\t' + " Thisney Normal " + "\n"
                    + "############################### \n"
                    + "  se realizo un cobro de $" + 160 + "\n"
